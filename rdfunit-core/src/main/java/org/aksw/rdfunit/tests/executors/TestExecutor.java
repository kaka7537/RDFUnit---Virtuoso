...
public abstract class TestExecutor {
     ...
     */
    protected abstract Collection<TestCaseResult> executeSingleTest(TestSource testSource, TestCase testCase, Model testModel) throws TestCaseExecutionException;
     ...
     */
    public boolean execute(TestSource testSource, TestSuite testSuite, Model testModel) {
		...
		//System.out.println(testCase);
                results = executeSingleTest(testSource, testCase, testModel);
